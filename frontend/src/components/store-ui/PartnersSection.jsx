        ...
        <div className="row g-4">
          <div className="col-lg-6">
            <div className="cta-box cta-delivery rounded-5 p-4 p-md-5 h-100">
              ...
              <Link to="/register/delivery" className="btn btn-dark rounded-pill px-4">Apply as Agent</Link>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="cta-box cta-shop rounded-5 p-4 p-md-5 h-100">
              ...
              <Link to="/register/shop" className="btn btn-success rounded-pill px-4">Start Selling</Link>
            </div>
          </div>
        </div>
      </div>
